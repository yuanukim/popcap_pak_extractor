...
##### 这个项目同时提供 C 和 C++17 的版本，可以自行修改 CMakeLists.txt 来决定编译哪一个版本。
...
##### This project provides both C and C++17 version, you can modify the CMakeLists.txt to determine which one to be built.
